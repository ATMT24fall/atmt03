...
CHECKPOINTS_DIR="$BASE_DIR/checkpoints_tiny"
TRANSLATIONS_FILE="$BASE_DIR/translations_tiny.txt"
POSTPROCESSED_FILE="$BASE_DIR/translations_tiny.p.txt"
...
RESULTS_FILE="$BASE_DIR/bleu_results_tiny.txt"
